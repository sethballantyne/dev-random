Paint+ is a simple network-based paint program I wrote to play around with
SDL and SDL_net. The application will be behave as a server or client
depending on the command line arguments passed to it, and anything painted
in the client will appear in the server in real-time and vice versa.
...
Paint+ <ip> <port>, where ip is the address it should connect to and
